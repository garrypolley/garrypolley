...
Project a 401(k) with round-number steppers, then use the sliders above the chart to compare **expected return** (annual effective) vs **loan APR**. Taking a loan pulls that cash out of the invested balance — it does not compound until you pay it back. Each repayment (principal and interest from your paycheck) is added back to the 401(k) and then earns the expected return. The chart and table show the **invested** balance, and the table has a **gain/loss** column versus keeping the money in the market. Turn on **Repeat this loan** to take another one each time the term ends. Contributions rise 3% a year after year 1.
